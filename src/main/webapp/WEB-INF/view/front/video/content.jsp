...
<div class="catalog">
	<div class="container">
		...
		<c:forEach items="${videoList}" var="video" >
			<div class="chapter">
				<p class="biaoti"><a href="front/video/index.action?videoId=${video.id}&subjectId=${subjectId}&speakerId=${video.speakerId}">${video.videoTitle}</a></p>
				...
				<div class="v-info">
					...
					<span class="duration"><img src="static/img/player.png" alt="">${video.videoLength1}</span>
				</div>
			</div>
		</c:forEach>
