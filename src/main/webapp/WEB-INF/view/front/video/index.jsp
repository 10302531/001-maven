...
<div>
    ...
    <input type="hidden" id="videoId" value="${videoId}">
     ...
     <input type="hidden" id="courseId" value="${video.courseId}">
    ...
    <script>
        $(function () {
           ...
           $('#content').load('front/video/videoData.action?videoId='+id+'&speakerId='+speakerId+'&courseId='+courseId+'&subjectId='+subjectId);
