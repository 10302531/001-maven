...
<body class="w100">
				...
				<div class="section">
					...
					<ul>
						<c:forEach items="${course.videoList}" var="video">
							...
							<input type="hidden" id="speakerId" value="${video.speakerId}">
							<div class="thum" style="background-image: url(${video.videoImageUrl})"></div>
								...
								<div class="classify-v-info">
									...
									<span class="duration" title="视频时长">
										<img src="static/img/player.png" alt="">${video.videoLength1}</span>
								</div>
							</li>
						</c:forEach>
					</ul>
	...
	<script type="text/javascript">
		function getVideo(id){
			...
			location.href='front/video/index.action?videoId='+id+'&subjectId='+subjectId+'&speakerId='+speakerId;
		}
	</script>
